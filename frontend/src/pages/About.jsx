    ...
    <div className="flex-grow flex flex-col bg-background">
      ...
      <div className="relative py-32 md:py-40 overflow-hidden bg-gradient-to-br from-[#013220]/5 via-background to-[#013220]/10 border-b border-border shadow-inner">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10 space-y-6">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-bold text-foreground uppercase tracking-widest drop-shadow-sm">
            About <span className="inline-block mt-2"><span className="text-[#013220] italic">Ethio</span><span className="text-primary italic">Explore</span></span>
          </h1>
      ...
      <div className="bg-card py-24 border-t border-border">
         <div className="max-w-4xl mx-auto text-center px-4">
            ...
            <a href="mailto:admin@ethioexplore.com" className="w-full sm:w-auto inline-block text-center px-10 py-4 bg-primary text-primary-foreground font-bold rounded-full hover:scale-105 hover:bg-primary/90 hover:shadow-2xl transition-all shadow-xl border-2 border-white/90">
               Contact The Team
            </a>
         </div>
      </div>
